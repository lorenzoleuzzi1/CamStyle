...
python train.py --dataroot ./datasets/market --name market-c1-c7 --camA 1 --camB 7
python train.py --dataroot ./datasets/market --name market-c1-c8 --camA 1 --camB 8
...
python train.py --dataroot ./datasets/market --name market-c2-c7 --camA 2 --camB 7
python train.py --dataroot ./datasets/market --name market-c2-c8 --camA 2 --camB 8
...
python train.py --dataroot ./datasets/market --name market-c2-c7 --camA 3 --camB 7
python train.py --dataroot ./datasets/market --name market-c2-c8 --camA 3 --camB 8
...
python train.py --dataroot ./datasets/market --name market-c4-c7 --camA 4 --camB 7
python train.py --dataroot ./datasets/market --name market-c4-c8 --camA 4 --camB 8
